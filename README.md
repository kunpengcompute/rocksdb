...
以rocksdb-8.3.3-kae_zstd分支为例，参考[特性指南](docs/zh/feature_guide)完成环境部署。
...
环境要求、编译安装指南详见[特性指南](docs/zh/feature_guide)。
...
本项目的文档适用于CC-BY 4.0许可证，具体请参见[LICENSE文件](docs/LICENSE-DOCS)。
