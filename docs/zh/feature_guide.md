...
| 项目    | 规格                                              |
|-------|-------------------------------------------------|
| CPU型号 | 华为鲲鹏920处理器 <br/> 华为鲲鹏920新型号处理器 <br/> 华为鲲鹏950处理器 |

**软件要求<a name="section1240364411598"></a>**

| 项目      | 版本                                                                              |
|---------|---------------------------------------------------------------------------------|
| 操作系统    | openEuler 22.03 LTS SP1 <br/> openEuler 22.03 LTS SP2 <br/> Debian GNU/Linux 10 |
...
5. 在KAE源码包目录中请参见以下步骤分模块进行安装。
    1. 安装内核驱动。
        1. 执行以下命令安装内核驱动。
            ...
            >![](public_sys-resources/icon-note.gif) **说明：** 
            > 
            >若当前内核在编译时未启用curve25519相关模块而出现报错，可参考[链接](https://gitcode.com/boostkit/KAE/commit/eea16ad40e2defdaeb3bfc05d5dfc8b77b8b1798?ref=dev_kae2_forByteDance)进行修改。
...
## RocksDB编译安装<a name="ZH-CN_TOPIC_0000002520682864"></a>
