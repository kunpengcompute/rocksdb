...
| Java | 11 | 通过yum源安装 |
| CRC32C标矢量混合优化patch | 0002_crc32c_opt.patch | [获取链接](https://gitcode.com/boostkit/rocksdb/tree/master/src/rocksdb-6.26.1/feature-patches/0002_crc32c_opt.patch) |
...
7. 执行YCSB测试，验证CRC32C标矢量混合优化特性是否生效。
